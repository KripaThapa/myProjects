package com.kripa.flightreservation.util;
...
public class EmailUtil {
	...
	@Value("${com.kripa.flightreservation.itinerary.email.body}")
	private String EMAIL_BODY;
	
	@Value("${com.kripa.flightreservation.itinerary.email.subject}")
